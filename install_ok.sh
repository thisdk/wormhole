...
docker run --restart=always --network host --name kcptun -d kcptun -l 127.0.0.1:8400 -t 127.0.0.1:8388 -mode fast3 -nocomp -mtu 256 -crypt none -sndwnd 2048 -rcvwnd 2048 -datashard 0 -parityshard 0 -dscp 46
