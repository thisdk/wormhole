...
docker run --restart=always --network host --name udp2raw_kcp --cap-add NET_ADMIN -d udp2raw -s -l0.0.0.0:8585 -r127.0.0.1:29900 -k jason --raw-mode faketcp --cipher-mode none --auth-mode none --keep-rule -a
